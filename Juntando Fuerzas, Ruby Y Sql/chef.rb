...
# Ya que los programadores solemos ser muy flojos, en este ejercicio vamos a
#  crear métodos que nos ayuden a dejar de escribir SQL, para solamente escribir Ruby.

# Vamos a usar la tabla de chefs del ejercicio de Recetas de Comida para empezar a
#  crear nuestra base de datos desde Ruby.
...
# irb> Chef.seed
# => []
# Verifica desde la consola de Sqlite que se halla creado la tabla y que se halla 
# poblado con los registros que creaste en la función seed. Nuestra base de datos se llama chefs.db.
...
# NOTA: Fíjate en la segunda forma de pasar parámetros a la claúsula WHERE. El ? se llama 
# placeholder y sirve para evitar ataques de SQL injection. Busca más información sobre SQL injection.
